  ...
  return (
    <div className="min-h-screen bg-luxury-black">
      ...
      <main>
              ...
              <div className="relative">
                ...
                <div className="space-y-8 text-luxury-text mb-8">
                  <div className="border-l-2 border-luxury-gold/30 pl-6">
                    <div className="text-luxury-gold/80 text-sm mb-2 tracking-wider">GESAMTFLÄCHE</div>
                  ...
                  <div className="border-l-2 border-luxury-gold/30 pl-6">
                    <div className="text-luxury-gold/80 text-sm mb-2 tracking-wider">ERLEBNISWELTEN</div>
                    <p className="text-lg leading-relaxed">
        ...
        {/* Experience Journey - Split Screen */}
          ...
          <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32">
              <div className="lg:order-2 relative">
                <div className="relative aspect-[4/3] bg-luxury-gray/10 border border-luxury-gold/20">
              ...
              <div className="lg:order-1 space-y-8">
                <div>
                  <div className="text-luxury-gold/60 text-sm tracking-widest mb-4">BERATUNG</div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32">
              ...
              <div className="space-y-8">
                <div>
                  <div className="text-luxury-gold/60 text-sm tracking-widest mb-4">AUSSTELLUNG</div>
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-thin text-luxury-white mb-6 leading-tight">
                    Show-Bäder
                  </h3>
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <div className="lg:order-1 space-y-8">
                <div>
                  <div className="text-luxury-gold/60 text-sm tracking-widest mb-4">MATERIALIEN</div>
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-thin text-luxury-white mb-6 leading-tight">
                    Materialwelt
                  </h3>
